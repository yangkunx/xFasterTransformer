...
parser.add_argument("-t", "--token_path", type=str, default="/data/models/Qwen-72B-Chat", help="Path to token file")
parser.add_argument("-m", "--model_path", type=str, default="/data/models/Qwen-72B-Chat-xft", help="Path to model file")
...
class QwenDemo(ChatDemo):
    ...
    def create_chat_input_token(self, query, history):
        ...
        print(f"im_start: {im_start}, im_start_tokens = {im_start_tokens}")
        print(f"im_end: {im_end}, im_end_tokens = {im_end_tokens}")
        print(f"\\n token = {nl_tokens}")
        print(f"'Human:' token = {human_tokens}")
